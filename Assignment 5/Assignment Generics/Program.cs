...
internal interface IVehicle {
    ...
    internal class MercedesBenz : IVehicle {
        ...
        public void getDetails() 
        {
            Console.Write("\tBrand : MercedesBenz \n");
            Console.Write($"Car Number : {number}\n");
            Console.Write($"Total Seats : {seater}\n");
            Console.Write($"Type : {type}\n");
            Console.Write($"Car age : {age}\n");
...
class Program {
    static void Main(string[] args) {
        ...
        Indica i1 = new Indica("Petrol", 5, "JK-06-LN-6369", IVehicle.Renttype.Day, 17, 11, new DateOnly(2021, 11,10 ));

        MercedesBenz mb1 = new MercedesBenz("Diesel",7, "GJ-01-BC-7198", IVehicle.Renttype.KM, 4, 11, new DateOnly(2020, 07,19 ));

        Qualis q1 = new Qualis("Diesel", 7, "UP-04-GS-5700", IVehicle.Renttype.KM, 7, 5, new DateOnly(2021, 11,21));

        Qualis q2 = new Qualis("CNG", 4, "GJ-01-BY-0210", IVehicle.Renttype.KM, 15, 14, new DateOnly(2022, 02,28 ));

        MercedesBenz mb2 = new MercedesBenz("Petrol",7, "GJ-01-AB-6975", IVehicle.Renttype.KM, 3, 17, new DateOnly(2020, 10,26 ));
